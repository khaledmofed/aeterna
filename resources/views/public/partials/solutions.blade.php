<section id="solutions" class="py-24 px-6" style="background:#0D0D0D">
  <div class="max-w-7xl mx-auto">
    ...
    <div class="overflow-hidden" style="border:1px solid rgba(255,255,255,0.08);border-radius:16px" data-animate>
      <!-- Header row -->
      <div class="grid" style="grid-template-columns:1fr 1.4fr 1.4fr;display:grid;background:rgba(255,255,255,0.04);border-bottom:1px solid rgba(255,255,255,0.08)">
      ...
      <div class="grid transition-colors duration-200 hover:bg-white/[0.02]"
           style="grid-template-columns:1fr 1.4fr 1.4fr;display:grid;{{ !$loop->last ? 'border-bottom:1px solid rgba(255,255,255,0.06)' : '' }}">
        <div class="px-6 py-5 font-semibold text-sm" style="color:#FFFFFF">{{ $row->challenge }}</div>
        <div class="px-6 py-5 text-sm leading-relaxed" style="color:rgba(255,255,255,0.45);border-left:1px solid rgba(255,255,255,0.06)">{{ $row->current_state }}</div>
        <div class="px-6 py-5 text-sm leading-relaxed font-medium" style="color:#9FE870;border-left:1px solid rgba(255,255,255,0.06)">{{ $row->aeterna_solution }}</div>
      </div>
      @endforeach
    </div>
  </div>
