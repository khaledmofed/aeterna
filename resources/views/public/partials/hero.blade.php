<section id="hero" class="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden px-6 pt-24 pb-16" style="background:#E8E8E3">
  ...
  <div class="relative z-10 max-w-5xl mx-auto">
    ...
    <style>
      .app-dl-btn { background:#FFFFFF; border:1.5px solid #C0C0BA; text-decoration:none; }
      .app-dl-btn:hover { background:#F0F0EB; border-color:#A8A8A2; }
      .dark .app-dl-btn { background:rgba(255,255,255,.07); border:1.5px solid rgba(255,255,255,.18); }
      .dark .app-dl-btn:hover { background:rgba(255,255,255,.13); border-color:rgba(255,255,255,.28); }
      ...
      <div class="flex flex-col gap-3">
        <div class="flex gap-3">
          ...
          <a href="{{ $appStoreUrl }}" target="_blank"
            ...
            <div class="text-left">
              <div class="app-dl-label text-[10px] uppercase font-bold tracking-wider leading-none mb-1">{{ __('messages.app_download.install') }}</div>
