  ...
  <div class="row g-4">
    <div class="col-lg-8">
      <div class="admin-card p-4 mb-4">
        <h6 class="fw-semibold mb-4" style="color:var(--wise-ink)">Layer Info</h6>
        <div class="mb-3">
      ...
      <div class="admin-card p-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <button type="button" id="add-feature" class="btn btn-wise-secondary btn-sm">+ Add Feature</button>
        </div>
        <div id="features-container">
          @foreach(old('features', $layer->features_json ?? []) as $i => $feat)
          <div class="feature-row p-3 mb-3" style="background:var(--wise-canvas-soft);border-radius:var(--wise-r-md)">
            <div class="mb-2 row g-2">
              <div class="col-md-4">
                <input type="text" name="features[{{ $i }}][title]" class="form-control form-control-sm" placeholder="Title" value="{{ $feat['title'] ?? '' }}">
              </div>
              <div class="col-md-2">
                <input type="text" name="features[{{ $i }}][icon_svg]" class="form-control form-control-sm" placeholder="Icon" value="{{ $feat['icon_svg'] ?? '' }}">
              </div>
              <div class="col-md-5">
...
document.getElementById('add-feature').addEventListener('click', () => {
  ...
  <div class="feature-row p-3 mb-3" style="background:var(--wise-canvas-soft);border-radius:var(--wise-r-md)">
    <div class="row g-2">
      ...
      <div class="col-md-1"><button type="button" class="btn btn-wise-danger btn-sm w-100 remove-feat">✕</button></div>
    </div>
  </div>`);
  fi++;
});
