...
@section('content')
<div class="mb-4"><h1 class="h4 fw-bold text-white mb-0">{{ isset($useCase) ? 'Edit Use Case' : 'New Use Case' }}</h1></div>
  ...
  <div class="row g-4">
    <div class="col-lg-8">
      <div class="admin-card p-4 mb-4">
        ...
        <div class="mb-3"><label class="form-label">Icon SVG</label>
      ...
      <div class="admin-card p-4">
        <div class="d-flex justify-content-between mb-3">
          ...
          <button type="button" id="add-feat" class="btn btn-sm btn-outline-secondary" style="font-size:.78rem">+ Add</button>
        </div>
    ...
    <div class="col-lg-4">
      <div class="admin-card p-4">
        <div class="form-check form-switch mb-4">
          <input class="form-check-input" type="checkbox" name="is_active" value="1" id="is_active" {{ (old('is_active', $useCase->is_active ?? true)) ? 'checked' : '' }}>
        ...
        <a href="{{ route('admin.use-cases.index') }}" class="btn btn-outline-secondary w-100 mt-2">Cancel</a>
      </div>
    </div>
  </div>
</form>
